...
public class ItemStore : MonoBehaviour
{
   ...
   // public GameObject StoreSignPopup;
    ...
    public void SmallItemButtonOn()
    {
        ...
        itemName_Text.text = "소형 산소통";
        itemConect_Text.text = "우주 휴게소 충전없이도 산소 10분 충전 가능";
    }
    //대형산소통 구매 버튼
    public void BigItemButtonOn()
    {
        ...
        itemName_Text.text = "대형 산소통";
        itemConect_Text.text = "우주 휴게소 충전없이도 산소 20분 충전 가능";
    }
    //에너지바 구매버튼
    public void EnergyItemButtonOn()
    {
        ...
        itemName_Text.text = "별가루 부스터";
        itemConect_Text.text = "10분 동안 내 걸음이 2배로 빨라집니다.";
    }
    ...
    public void BuyItemButtonOn()
    {
        ...
        if(itemKind == "Small")
        {
            ...
            if(coin_i >= price)
            {
                ...
                Game_UIManager.instance.StoreSignPopup_Text.text = "구매 완료되었습니다.";
            ...
            {
                Game_UIManager.instance.StoreSignPopup.SetActive(true);
                Game_UIManager.instance.StoreSignPopup_Text.text = "코인이 부족합니다.";
