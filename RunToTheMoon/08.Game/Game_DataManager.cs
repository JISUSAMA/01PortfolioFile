...
public class Game_DataManager : MonoBehaviour
{
    ...
    */
    ...
    public void SaveProcessingData()
    {
        ...
        //ServerManager.Instance.dataByDate[ServerManager.Instance.dataByDate.Count - 1].today_Distance = PlayerPrefs.GetFloat("Today_Distance");
        PlayerPrefs.SetInt("Today_StepCount", today_stepCount + once_stepCount);
        Debug.Log("today : " + today_stepCount + "once : " + once_stepCount );
        //ServerManager.Instance.dataByDate[ServerManager.Instance.dataByDate.Count - 1].today_StepCount = PlayerPrefs.GetInt("Today_StepCount");
        //steps = 0;
        
        PlayerPrefs.SetInt("Player_ConnectDay", timeCalDay);
        PlayerPrefs.SetString("Today_StepTime", PlusTodayTime(todayTime));
        //ServerManager.Instance.dataByDate[ServerManager.Instance.dataByDate.Count - 1].today_StepTime = PlayerPrefs.GetString("Today_StepTime");
        ...
        //ServerManager.Instance.dataByDate[ServerManager.Instance.dataByDate.Count - 1].today_Kcal = PlayerPrefs.GetFloat("Today_Kcal");
