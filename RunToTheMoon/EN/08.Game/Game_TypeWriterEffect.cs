   ...
   // }
    ...
    void MapChartList()
    {
        ...
        if (Game_DataManager.instance.moonDis % 50 == 0)
        {
            ...
            if (wayPoint.Equals(1)) TitleText = " Start of the Journey"; //1 0-50
            else if (wayPoint.Equals(2)) TitleText = " Aimless Footsteps";//2 51-100
            else if (wayPoint.Equals(3)) TitleText = " Secrets of the Moon"; //3
            else if (wayPoint.Equals(4)) TitleText = " String of Hope"; //4
            else if (wayPoint.Equals(5)) TitleText = " The Lost Baby Star"; //5
            else if (wayPoint.Equals(6)) TitleText = "  Lingering Void"; //6
            else if (wayPoint.Equals(7)) TitleText = " Flock of Light"; //7
            else if (wayPoint.Equals(8)) TitleText = " Suspicious Light"; //8
            else if (wayPoint.Equals(9)) TitleText = "  Help Me!"; //9
            else if (wayPoint.Equals(10)) TitleText = " Fireworks";   //10
            else if (wayPoint.Equals(11)) TitleText = " Wishing Stone";    //11
            else if (wayPoint.Equals(12)) TitleText = " Struggling Sentiments";  //12
            else if (wayPoint.Equals(13)) TitleText = " A Soul Wandering in Space";    //13
            else if (wayPoint.Equals(14)) TitleText = " A Journey Together";    //14
            else if (wayPoint.Equals(15)) TitleText = " The Owner of the Necklace";    //15
            else if (wayPoint.Equals(16)) TitleText = " Hello, Constellations";    //16
            else if (wayPoint.Equals(17)) TitleText = " Dream World"; //17
            else if (wayPoint.Equals(18)) TitleText = " Closer and Closer";   //18
            else if (wayPoint.Equals(19)) TitleText = " The Colorless Light";    //19
            else if (wayPoint.Equals(20)) TitleText = " Temple of the Moon";  //20
