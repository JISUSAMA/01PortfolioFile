...
public class RunnerPlayer1 : MonoBehaviour
{
    ...
    IEnumerator _Show_Sign(string name)
    {
        ...
        if (name.Equals("Cnt_MoonPowder"))
        {
            ...
            Game_UIManager.instance.StoreSignPopup_Text.text = "This item can only be used in certain sections.";
        }
        else if (name.Equals("Oxygen_Small"))
        {
            player_Ox_state.material = _Ox_states[0];
            Game_UIManager.instance.StoreSignTitle_Text.text = "Use of Small oxygen tank";
            Game_UIManager.instance.StoreSignPopup_Text.text = "10 minutes of oxygen is charged.";

        }
        else if (name.Equals("Oxygen_Big"))
        {
            player_Ox_state.material = _Ox_states[1];
            Game_UIManager.instance.StoreSignTitle_Text.text = "Use of Large oxygen tank";
            Game_UIManager.instance.StoreSignPopup_Text.text = "20 minutes of oxygen is charged.";
        }
        else if (name.Equals("StarDust"))
        {
            Game_UIManager.instance.StoreSignTitle_Text.text = "Use of Stardust";
            Game_UIManager.instance.StoreSignPopup_Text.text = "Step 2x faster for 10 minutes.";
        }
        yield return new WaitForSeconds(2f);
