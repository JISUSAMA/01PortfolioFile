...
public class Lobby_UIManager : MonoBehaviour
{
    ...
    void CennectDay_MapName()
    {
        ...
        if (way.Equals(1000)) connectDay_title = " Hall of fame";  //명예의 전당
        else
        {
            if (wayPoint.Equals(1)) connectDay_title = " Start of the Journey"; //1 0-50
            else if (wayPoint.Equals(2)) connectDay_title = " Aimless Footsteps";//2 51-100
            else if (wayPoint.Equals(3)) connectDay_title = " Secrets of the Moon"; //3
            else if (wayPoint.Equals(4)) connectDay_title = " String of Hope"; //4
            else if (wayPoint.Equals(5)) connectDay_title = " The Lost Baby Star"; //5
            else if (wayPoint.Equals(6)) connectDay_title = "  Lingering Void"; //6
            else if (wayPoint.Equals(7)) connectDay_title = " Flock of Light"; //7
            else if (wayPoint.Equals(8)) connectDay_title = " Suspicious Light"; //8
            else if (wayPoint.Equals(9)) connectDay_title = "  Help Me!"; //9
            else if (wayPoint.Equals(10)) connectDay_title = " Fireworks";   //10
            else if (wayPoint.Equals(11)) connectDay_title = " Wishing Stone";    //11
            else if (wayPoint.Equals(12)) connectDay_title = " Struggling Sentiments";  //12
            else if (wayPoint.Equals(13)) connectDay_title = " A Soul Wandering in Space";    //13
            else if (wayPoint.Equals(14)) connectDay_title = " A Journey Together";    //14
            else if (wayPoint.Equals(15)) connectDay_title = " The Owner of the Necklace";    //15
            else if (wayPoint.Equals(16)) connectDay_title = " Hello, Constellations";    //16
            else if (wayPoint.Equals(17)) connectDay_title = " Dream World"; //17
            else if (wayPoint.Equals(18)) connectDay_title = " Closer and Closer";   //18
            else if (wayPoint.Equals(19)) connectDay_title = " The Colorless Light";    //19
            else if (wayPoint.Equals(20)) connectDay_title = " Temple of the Moon";  //20
        }
    }
    //첫 로그인 코인 받기
    ...
    {
        Lobby_DataManager.instance.NickName_OverLap_Check(nick_Field.text, overlapText);
        if (overlapText.text == "This is an available nickname.")
        {
    ...
    void ErrorPopup_Sign()
    {
        ...
        BlurCamera_ob.SetActive(true);
        errer_Text.text = "You succeeded in changing your nickname.";
    }
    //각 [자세히보기]버튼 씬 전환
