...
public class Lobby_DataManager : MonoBehaviour
{
    ...
    void Start()
    {
        Debug.Log("today step " + PlayerPrefs.GetInt("Today_StepCount"));
...
/*        //특수문자 사용
        ...
        {
            _overlapText.text = "This is an available nickname.";
        }
        //중복체크를 하지 않았다.
        ...
        {
            _overlapText.text = "Please enter your nickname within 1 to 10 characters.";
            SoundFunction.Instance.Warning_Sound();
        }
        else if (unavailableState == true)
        {
            _overlapText.text = "This nickname cannot be used.";
            SoundFunction.Instance.Warning_Sound();
        }
        //둘중 하나라도 아닐 경우
        else
        {
            //닉네임을 저장할 수 없다.
            _overlapText.text = "Please set your nickname again.";
            SoundFunction.Instance.Warning_Sound();
        }
