...
public class RunKcalGraphDrawLine : MonoBehaviour
{
    public static RunKcalGraphDrawLine instance { get; private set; }
    ...
    IEnumerator _GraphDrawLineMake()
    {
        ...
        {
            graphPos[i] = new Vector3(graph[graphIndex[i]].transform.position.x, graph[graphIndex[i]].transform.position.y, 80f);
