...
public class ManCtrl : MonoBehaviour
{
    ...
    {
        //머리 세팅
        if (PlayerPrefs.GetString("AT_Player_Hair") == "Hair1")  //동양
        {
            HairSetting(true, false, false, false);
        }
        else if (PlayerPrefs.GetString("AT_Player_Hair") == "Hair2") //서양
        {
            HairSetting(false, true, false, false);
        }
        else if (PlayerPrefs.GetString("AT_Player_Hair") == "Hair3") //흑인
        {
            HairSetting(false, false, true, false);
        }
        else if (PlayerPrefs.GetString("AT_Player_Hair") == "HelmetHair")
        {
            HairSetting(false, false, false, true); //헬맷착용 시 머리
        }

        //얼굴 세팅
        if (PlayerPrefs.GetString("AT_Player_Face") == "Asian")
        {
            FaceSetting(true, false, false);
        }
        else if (PlayerPrefs.GetString("AT_Player_Face") == "White")
        {
            FaceSetting(false, true, false);
        }
        else if (PlayerPrefs.GetString("AT_Player_Face") == "Black")
        {
        ...
        else if (PlayerPrefs.GetString("AT_Wear_GlovesKind") == "ItemID_Gloves")
        {
        ...
        else if (PlayerPrefs.GetString("AT_Wear_HelmetKind") == "ItemID_Helmet")
        {
            helmelObj[0].SetActive(true); //헬맷잇음
        }
        //상의
        if (PlayerPrefs.GetString("AT_Wear_JacketKind") == "ItemID_Nais")
        {
            JacketSetting(true, false, false);  //기본나시
        }
        else if (PlayerPrefs.GetString("AT_Wear_JacketKind") == "ItemID_Tshirt")
        {
            JacketSetting(false, true, false);  //반팔
        }
        else if (PlayerPrefs.GetString("AT_Wear_JacketKind") == "ItemID_LongShirt")
        {
            JacketSetting(false, false, true);  //긴팔
        }
        //하의
        if (PlayerPrefs.GetString("AT_Wear_PantsKind") == "ItemID_Short")
        {
            PantsSetting(true, false);  //반바지
        }
        else if (PlayerPrefs.GetString("AT_Wear_PantsKind") == "ItemID_LongPants")
        {
            PantsSetting(false, true);  //긴바지
        }
        //신발
        if (PlayerPrefs.GetString("AT_Wear_ShoesKind") == "ItemID_Sandal")
        {
            ShoesSetting(true, false);  //샌들
        }
        else if (PlayerPrefs.GetString("AT_Wear_ShoesKind") == "ItemID_Shoes")
        {
    ...
    {
        //Debug.Log("머리 스타일 = " + PlayerPrefs.GetString("AT_Player_Hair"));
        if(_helmet == true)
        {
            if (PlayerPrefs.GetString("AT_Player_Hair") == "Hair2") //서양인 머리 일때
            {
                helmelObj[0].SetActive(_helmet);
                //서양머리 비활성화 - 헬맷쓴머리 활성화
                hairObj[1].SetActive(false); hairObj[3].SetActive(true);
                PlayerPrefs.SetString("AT_Player_Hair", "HelmetHair"); //플레이어 머리 변경
                PlayerPrefs.SetString("AT_Wear_HairStyleName", "HelmetHair");  //헤어스타일 변경
                PlayerPrefs.SetInt("AT_HairNumber", 3);    //헤어넘버 변경
                PlayerPrefs.SetString("AT_Wear_HelmetKind", "ItemID_Helmet");  //헬맷종류
            }
            else
            {
                helmelObj[0].SetActive(_helmet);
        ...
        else
        {
            if (PlayerPrefs.GetString("AT_Player_Hair") == "Hair2") //서양인 머리 일때
            {
                ...
                PlayerPrefs.SetString("AT_Player_Hair", "Hair2"); //플레이어 머리 변경
                PlayerPrefs.SetString("AT_Wear_HairStyleName", "Hair2");  //헤어스타일 변경
                PlayerPrefs.SetInt("AT_HairNumber", 1);    //헤어넘버 변경
                PlayerPrefs.SetString("AT_Wear_HelmetKind", "No"); //헬맷종류
            }
            else
            {
                helmelObj[0].SetActive(_helmet);
    ...
    public void PlayerSkinColorInit(string _skinColor)
    {
        if (_skinColor == "FaceBlack")
        {
            ...
            man_Skin_Rend[PlayerPrefs.GetInt("AT_BodyNumber")].SetPropertyBlock(propertyBlock);
    ...
    public void PlayerHairColorInit(string _hairColor)
    {
        if (_hairColor == "HairBlack")
        {
            ...
            man_Hair_Rend[PlayerPrefs.GetInt("AT_HairNumber")].SetPropertyBlock(propertyBlock);
        }
