...
public class WomanCtrl : MonoBehaviour
{
    ...
    {
        //머리 세팅
        if(PlayerPrefs.GetString("AT_Player_Hair") == "Hair1")
        {
            HairSetting(true, false, false);
        }
        else if(PlayerPrefs.GetString("AT_Player_Hair") == "Hair2")
        {
            HairSetting(false, true, false);
        }
        else if(PlayerPrefs.GetString("AT_Player_Hair") == "Hair3")
        {
    ...
    public void PlayerSkinColorInit(string _skinColor)
    {
        if (_skinColor == "FaceBlack")
        {
            ...
            woman_Skin_Rend[PlayerPrefs.GetInt("AT_BodyNumber")].SetPropertyBlock(propertyBlock);
            woman_Body_Rend[PlayerPrefs.GetInt("AT_BodyNumber")].SetPropertyBlock(propertyBlock);
        }
