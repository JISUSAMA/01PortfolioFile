        ...
        if (SceneManager.GetActiveScene().name != "Loading" && SceneManager.GetActiveScene().name != "GameFinish")
        {
            ...
            if (fit_tagPopup.activeSelf.Equals(true))
            {
                ...
                if (SceneManager.GetActiveScene().name.Equals("AsiaMap 3"))
                    connectImg = parentsObj_Canvas.transform.GetChild(0).transform.GetChild(9).transform.GetChild(1).GetComponent<Image>();
                else
                    connectImg = parentsObj_Canvas.transform.GetChild(1).transform.GetChild(1).GetComponent<Image>();
                ...
                {
                    //Text text_34 = GameObject.Find("Text (3)").GetComponent<Text>();
                    //text_34.text = "빨깡 _ 위 " + name + " connecting " + _connected;
                    //Debug.Log("1번 로고는 찍힘?");
                ...
                {
                    //Text text_34 = GameObject.Find("Text (3)").GetComponent<Text>();
                    //text_34.text = "초록 _ 위 " + name + " connecting " + _connected;
                    //Debug.Log("2번 로고는 찍힘?");
            ...
            else
            {
                ...
                {
                    //Text text_34 = GameObject.Find("Text (3)").GetComponent<Text>();
                    //text_34.text = "빨깡 " + name + " connecting " + _connected;
                    //커넥트 연결 빨강
                    if (SceneManager.GetActiveScene().name.Equals("AsiaMap 3"))
                        parentsObj_Canvas.transform.GetChild(0).transform.GetChild(9).transform.GetChild(1).GetComponent<Image>().sprite = connectSprite[0];
                    else
                        parentsObj_Canvas.transform.GetChild(1).transform.GetChild(1).GetComponent<Image>().sprite = connectSprite[0];

                    //PlayerPrefs.SetString("AT_SensorIcon", "Off_ICON");
                }
                else
                {
                    //Text text_34 = GameObject.Find("Text (3)").GetComponent<Text>();
                    //text_34.text = "초록 " + name + " connecting " + _connected;
                    //Debug.Log("2 여긴 들어오쥬");
                    //커넥트 연결 초록
                    if (SceneManager.GetActiveScene().name.Equals("AsiaMap 3"))
                        parentsObj_Canvas.transform.GetChild(0).transform.GetChild(9).transform.GetChild(1).GetComponent<Image>().sprite = connectSprite[1];
                    else
                        parentsObj_Canvas.transform.GetChild(1).transform.GetChild(1).GetComponent<Image>().sprite = connectSprite[1];

                    //PlayerPrefs.SetString("AT_SensorIcon", "On_ICON");
                }
            }
        }
    }
        ...
        if (_timeout > 0f)
        {
            ...
            if (_timeout <= 0f)
            {
                ...
                switch (_state)
                {
                    ...
                    case States.Scan:
                        setStateTextAcc("Scanning for ESP32 devices...");
                        ...
                        {
                            if (PlayerPrefs.GetString("AT_SensorAddr").Equals(""))
                            {
                                //Text text_2 = GameObject.Find("Text (2)").GetComponent<Text>();
                                //text_2.text = "connecting : " + _connected + " name " + name;
                                //찾고자 하는 것에 포함되어 있는지
                                if (name.Contains(DeviceName))
                                {
                                    ...
                                    if (PlayerPrefs.GetString("AT_SensorAddr").Equals(""))
                                        PlayerPrefs.SetString("AT_SensorAddr", address);
                            ...
                            else
                            {
                                ...
                                if (name.Contains(AddStr(PlayerPrefs.GetString("AT_SensorAddr"))))
                                {
                                    ...
                                    //Text text_34 = GameObject.Find("Text (3)").GetComponent<Text>();
                                    //text_34.text = "SensorAddr 2: " + name + " connecting " + _connected;
                                }
                                else
                                {
                                    //Text text_34 = GameObject.Find("Text (3)").GetComponent<Text>();
                                    //text_34.text = "ㄴㅇㅁㄴㅇㅁㄴ " + name + " connecting " + _connected;
                                ...
                                //text_1.text = "SensorAddr 1: " + AddStr(PlayerPrefs.GetString("AT_SensorAddr")) + " connecting " + _connected + " 'name' " + name + " 'address' " + address;
                            }
                    ...
                    case States.Connect:
                        ...
                        BluetoothLEHardwareInterface.ConnectToPeripheral(_deviceAddress, null, null,
                            (address, serviceUUID, characteristicUUID) =>
                            {
                                ...
                                if (PlayerPrefs.GetString("AT_SensorAddr").Equals(address))
                                {
                                    if (IsEqual(serviceUUID, FullUUID(ServiceUUID)))
                                    {
                                        ...
                                        if (IsEqual(characteristicUUID, FullUUID(Characteristic)))
                                        {
                                            ...
                                            if (PlayerPrefs.GetString("AT_Player_Sex").Equals("Man"))
                                            {
                                                Man_Move.instance.connetState = true;
                                            }
                                            else if (PlayerPrefs.GetString("AT_Player_Sex").Equals("Woman"))
                                            {
