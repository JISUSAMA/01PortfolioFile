...
/*
    ...
    public GameObject LastOB;
    public Image Count;
    public Sprite[] countNum;
   ...
   //     panel_NextNumber.SetActive(false);
    ...
    {
        StartCoroutine(_LastScene());
    }
    IEnumerator _LastScene()
    {
        Debug.Log("다음으로 넘어감");
        ...
        LastOB.SetActive(true);
        StartCoroutine(_count_5());
        yield return null; 
    }
  
    IEnumerator _count_5()
    {
        for(int i=0; i<countNum.Length; i++)
        {
            Count.sprite = countNum[i];
            yield return new WaitForSeconds(1f);
        }
        GameManager.Instance.NextScenes(); // 최종점수로 이동.
        yield return null; 
    }
    ...
    public void SceneName()
    {
        ...
        if (SceneManager.GetActiveScene().buildIndex.Equals(2))
        {
            if (GameManager.RankMode.Equals(true))
            {
                gameName_rank.text = "괴물새를 맞춰라";           
            }
            else
            {
                gameName_clas.text = "괴물새를 맞춰라";
        ...
        else  if (SceneManager.GetActiveScene().buildIndex.Equals(4))
        {
            if (GameManager.RankMode.Equals(true))
            {
                gameName_rank.text = "장난감을 완성하라";            
            }
            else
            {
                gameName_clas.text = "장난감을 완성하라";
                getScore_clas.text = DataManager.Instance.scoreManager.score.ToString();
            }
        }
        //전골
        ...
        else if (SceneManager.GetActiveScene().buildIndex.Equals(6))
        {
            if (GameManager.RankMode.Equals(true))
            {
                gameName_rank.text = "조각상을 완성하라";   
            }
            else
            {
                gameName_clas.text = "조각상을 완성하라";
                getScore_clas.text = DataManager.Instance.scoreManager.score.ToString();
            }
        }
        //좀비
        else if (SceneManager.GetActiveScene().buildIndex.Equals(7))
        {
            if (GameManager.RankMode.Equals(true))
            {
                gameName_rank.text = "좀비를 맞춰라";          
            }
            else
            {
                gameName_clas.text = "좀비를 맞춰라";
                getScore_clas.text = DataManager.Instance.scoreManager.score.ToString();
            }
        }
        //청기백기
        else if (SceneManager.GetActiveScene().buildIndex.Equals(8))
        {
            if (GameManager.RankMode.Equals(true))
            {
                gameName_rank.text = "청기 백기";             
            }
            else
            {
                gameName_clas.text = "청기 백기";
                getScore_clas.text = DataManager.Instance.scoreManager.score.ToString();
            }
        }
        //호스
        else if (SceneManager.GetActiveScene().buildIndex.Equals(9))
        {
            if (GameManager.RankMode.Equals(true))
            {
                gameName_rank.text = "밸브를 잠가라";
            }
            else
            {
                gameName_clas.text = "밸브를 잠가라";
                getScore_clas.text = DataManager.Instance.scoreManager.score.ToString();
            }
        ...
        //피자
        else if (SceneManager.GetActiveScene().buildIndex.Equals(11))
        {
            if (GameManager.RankMode.Equals(true))
            {
