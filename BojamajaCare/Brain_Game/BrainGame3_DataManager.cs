...
public class BrainGame3_DataManager : MonoBehaviour
{
    public BrainGame3_UIManager UIManager;
    public bool playBool = false;
    public float AnswerTimer_f; //15초

    public static BrainGame3_DataManager instance { get; private set; }
    ...
    public void BrainGame3_Play()
    {
        StopCoroutine("_BrainGame3_Play");
        StartCoroutine("_BrainGame3_Play");
    }
    IEnumerator _BrainGame3_Play()
    {
