...
public class DementiaGame1_DataManager : MonoBehaviour
{
    ...
    IEnumerator _FindWord_sec_Timer()
    {
        ...
        //점수 Set
        if (AnswerTimer_f > 5) { Touch_GameManager.instance.CurrentGameScore = 20; }
        else if (AnswerTimer_f > 3) { Touch_GameManager.instance.CurrentGameScore = 10; }
        else if (AnswerTimer_f > 0) { Touch_GameManager.instance.CurrentGameScore = 5; }
        yield return null;
    }
}
